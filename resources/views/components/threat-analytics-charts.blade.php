...
@php
    ...
    $postureBadge = match(true) {
        ...
        $postureScore >= 75 => 'bg-sky-50 text-sky-700 border-sky-300 dark:bg-sky-950/60 dark:text-sky-400 dark:border-sky-800',
...
<div class="space-y-4">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-1">
        <div class="flex items-center space-x-3">
            <div class="p-2 rounded-lg bg-indigo-600 text-white shadow-xs">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 dark:text-slate-400">Continuous 24-hour vector correlation and proactive defense readiness.</p>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-2">
            ...
            <a href="{{ request()->fullUrlWithQuery(['refresh' => 1]) }}"
               class="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-white hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-800/90 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 text-xs font-semibold transition cursor-pointer shadow-xs"
    ...
    <!-- Dual Charts Row: 24h Area Trend + Threat Distribution Donut -->
