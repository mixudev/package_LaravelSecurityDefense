...
<div class="bg-white dark:bg-[#121214] border border-zinc-200/90 dark:border-zinc-800 rounded-xl overflow-hidden shadow-xs">
    <div class="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between bg-zinc-50/70 dark:bg-[#18181b]">
        <div class="flex items-center space-x-2">
            ...
            <h3 class="text-sm font-bold text-zinc-900 dark:text-zinc-100">Session Intelligence Telemetry</h3>
        </div>
            ...
            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800 font-sans">
                @forelse($alerts as $alert)
                    <tr class="hover:bg-zinc-50/70 dark:hover:bg-zinc-800/30 transition">
                        ...
                        <!-- Threat Type -->
                        <td class="px-4 py-3">
                            <div class="font-bold text-zinc-900 dark:text-zinc-100 font-mono text-[11px]">
                                {{ $alert->threat_type }}
                            </div>
                            <div class="text-[10px] text-zinc-500 dark:text-zinc-400 font-mono">Rule: {{ $alert->rule_identifier ?? 'siem_engine' }}</div>
                        </td>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <div class="text-[10px] text-zinc-500 dark:text-zinc-400 font-mono">{{ $alert->created_at->diffForHumans() }}</div>
                        </td>
