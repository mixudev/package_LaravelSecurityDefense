<header class="sticky top-0 z-30 border-b border-zinc-200/90 dark:border-zinc-800 bg-white/95 dark:bg-[#101012]/95 backdrop-blur-md shadow-xs">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('security-defense.dashboard') }}" class="flex items-center space-x-3 group">
                    <div class="w-9 h-9 rounded-lg bg-zinc-900 dark:bg-zinc-100 flex items-center justify-center text-white dark:text-zinc-950 font-bold group-hover:scale-105 transition shadow-xs">
                    ...
                    <div>
                        <div class="flex items-center space-x-2">
                            <span class="text-sm font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Security Defense</span>
            ...
            <nav aria-label="Primary navigation" class="hidden md:flex items-center space-x-1 font-sans text-xs">
                @php
                ...
                <a href="{{ route('security-defense.epistemic') }}"
                   class="inline-flex items-center px-3 py-2 rounded-md transition font-medium {{ $currentRoute === 'security-defense.epistemic' ? 'bg-zinc-100 dark:bg-zinc-800/80 text-zinc-900 dark:text-white border border-zinc-200 dark:border-zinc-700 shadow-xs' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-50 dark:hover:bg-zinc-900' }}">
                    <svg class="w-4 h-4 mr-1.5 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex items-center space-x-2">
                ...
                <!-- Refresh Button -->
                <a href="{{ url()->current() }}" class="p-2 rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800 transition cursor-pointer" title="Refresh Telemetry" aria-label="Refresh telemetry">
        ...
        <div class="flex md:hidden border-t border-zinc-200 dark:border-zinc-800 py-2 space-x-2 overflow-x-auto text-xs font-sans">
            ...
            <a href="{{ route('security-defense.epistemic') }}"
               class="px-2.5 py-1.5 rounded-md whitespace-nowrap {{ $currentRoute === 'security-defense.epistemic' ? 'bg-zinc-200 dark:bg-zinc-800 font-semibold text-zinc-900 dark:text-white' : 'text-zinc-600 dark:text-zinc-400' }}">
                Epistemic Analysis
            </a>
        </div>
        @endif
